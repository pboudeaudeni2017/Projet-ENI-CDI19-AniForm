...
public class EcranGestionClient extends JPanel implements Observer {
    ...
    private DetailClientPanel detailClientPanelAnimal;
    ...
    public DetailClientPanel getDetailClientPanelAnimal(){
        if (this.detailClientPanelAnimal == null) {
            this.detailClientPanelAnimal = new DetailClientPanel();
        }
        return detailClientPanelAnimal;
    }
